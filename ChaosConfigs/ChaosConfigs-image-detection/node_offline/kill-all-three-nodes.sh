...
FAILURE_DURATION=30  # 将故障持续时间设为极短（1秒）
...
WORKER_NODE_1="zihaochen-mscminorthesis-cluster2-worker1"
WORKER_NODE_2="zihaochen-mscminorthesis-cluster2-worker2"
WORKER_NODE_3="zihaochen-mscminorthesis-cluster2-worker3"
